...
int main()
{
    ...
    CircleTrue = entered_data.compare(0, first_space, "circle") * entered_data.compare(0, left_bracket, "circle")
    ...
    if (Condition_is_met == 1)
    	cout << "perimeter = " << computation_perimeter(comma, right_bracket, entered_data) << endl 
		<< "area = " << computation_area(comma, right_bracket, entered_data) << endl;
